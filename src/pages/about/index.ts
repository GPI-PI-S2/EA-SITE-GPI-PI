	...
	IntegrantesList: aboutPage.TeammInfo []= [
		{
			...
			integrantes : [
				...
				{name: 'Mathias Cáceres', img:'', lider:true,extra:'Lider de investigación',email:'mathias.caceresb@utem.cl'},
				{name: 'Israel Ramirez', img:'',lider:true,extra:'Lider de documentación',email:'israel.ramirezc@utem.cl'}
			]
		},
		{
			...
			integrantes: [
				...
				{name:'Byron Diaz',img:'',lider:false,extra:'',email:'byron.diazj@utem.cl'},
		...
		},
		{
			...
			integrantes: [
				{name: 'Ricardo Aliste', img:'',lider:false,extra:'',email:'ricardo.alisteg@utem.cl'},
				...
				{name: 'José Carvallo', img:'',lider:false,extra:'',email:'JoseCarvalloxc@outlook.cl'},
				...
				{name: 'Sebastian Garrido', img:'',lider:false,extra:'',email:'sebastian.garridov@utem.cl'},
				{name: 'Mohamed Gorayeb', img:'',lider:false,extra:'',email:'mohamed.gorayebm@utem.cl'},
				{name: 'Benjamín Martinez', img:'',lider:false,extra:'',email:'benjamin.martinezg@utem.cl'},
