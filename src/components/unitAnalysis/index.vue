	...
	<q-card flat>
		...
		<div class="row q-pa-md q-col-gutter-sm">
			...
			<div class="row content-start col-xs-12 col-md-8">
				<div class="col-12 border rounded-borders q-pa-md">
					<div class="text-caption text-grey-7">Comentario</div>
					<cite>{{ this.model.comment }}</cite>
				</div>
...
"
			...
			<div class="col-xs-12 col-md-4">
				<q-list bordered class="rounded-borders" separator>
					...
					<q-item>
						<q-item-section side><q-icon name="mdi-calendar"/></q-item-section>
						<q-item-section>
							<q-item-label caption>Fecha de extracción</q-item-label>
							<q-item-label>{{ formattedDate }}</q-item-label>
						</q-item-section>
					</q-item>
					<q-item>
						<q-item-section side><q-icon name="mdi-tag"/></q-item-section>
						<q-item-section>
							<q-item-label caption>Versión del algorítmo</q-item-label>
					...
					<q-item>
						...
						/></q-item-section>
						<q-item-section>
							<q-item-label caption>Fecha de cálculo</q-item-label>
							<q-item-label>{{ completionDate }}</q-item-label>
						</q-item-section>
					</q-item>
				</q-list>
				<q-table
